...
//    @Query("select tc.courseId from TimetableCourse tc where tc.timetableId = :timetableId")
//    List<Long> findCourseIdsByTimetableId(@Param("timetableId") Long timetableId);
//
